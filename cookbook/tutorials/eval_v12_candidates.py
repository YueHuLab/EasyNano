"""Evaluate v12 Full in loop candidates with Full ESMFold2."""
...
def evaluate(snaps, out_path, init_seq, include_init=True,
             label_prefix="v12 step", init_label="v9 step 48 (init)"):
...
if __name__ == "__main__":
    ...
    p.add_argument("--snaps", default="/tmp/b5_v12_full_in_loop_snaps.json")
    p.add_argument("--out", default="/tmp/b5_v12_eval.json")
    p.add_argument("--label-prefix", default="v12 step")
